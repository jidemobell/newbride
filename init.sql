...
ALTER TABLE app.images ALTER COLUMN id SET NOT NULL;
ALTER TABLE app.pages ALTER COLUMN id SET NOT NULL;
ALTER TABLE app.cloudinary ALTER COLUMN id SET NOT NULL;
